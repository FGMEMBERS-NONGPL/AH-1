var hud_mode_knob_pos = props.globals.getNode("sim/model/AH-1/controls/hud/power");
...
var update_loop = func {
	...
	if(getprop("/systems/electrical/outputs/hud") >= 23) {
		...
		if(redout_alpha > 1)
			redout_alpha = 1;
		hud_alpha.setDoubleValue(getprop("/sim/model/AH-1/controls/hud/intens") - redout_alpha);
	} else {
